...
export const register = (userData) =>
  axios.post(`${process.env.REACT_APP_API_URL}/api/auth/register`, userData);
...
export const uploadProviderDocument = (providerId, file) => {
  ...
  return axios.post(
    `${process.env.REACT_APP_API_URL}/api/auth/upload-documents/${providerId}`,
    formData,
    {
...
export const verifyProvider = (providerId) => API.put(`/users/${providerId}/verify`);
